% Preprocessing batch script for the emotion regulation task of Maier &
...
folder.functional = 'functional/er/'; % folder with the functional images for this task (er = emotion regulation)
...
for i = 1:length(subjects)
    ...
    % retrieve T1 scan
    try T1anat = dir([anatPath filesep subRef searchString.T1 'nii']); end
    ...
    if toRun.fieldmap == 1
        ...
        for n = 1:length(scans)
            ...
            %enter information in matlabbatch:
    ...
    save([folder.scripts filesep prefix.preProcVersion subjects{i} '_er_run_batch.mat'],'matlabbatch');
